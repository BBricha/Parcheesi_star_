import { BASE_POSITIONS, HOME_ENTRANCE, HOME_POSITIONS, PLAYERS, SAFE_POSITIONS, START_POSITIONS, STATE, TURNING_POINTS } from './first.js';
import { UI } from './second.js';


export class Parcheesi {
    currentPositions = {
        P1: [],
        P2: []
    }
